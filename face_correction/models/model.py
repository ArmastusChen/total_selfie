...
from models.util import AntiAliasInterpolation2d, make_coordinate_grid_2d
...
class GeneratorFullModel(torch.nn.Module):
    ...
    def __init__(self, kp_extractor, he_estimator, generator, discriminator, train_params, estimate_jacobian=True, he_estimator_far=None):
        super(GeneratorFullModel, self).__init__()
        self.kp_extractor = kp_extractor
        self.he_estimator = he_estimator
        self.he_estimator_far = he_estimator_far
    ...
    def forward(self, x):
        ...
        he_driving = self.he_estimator_far(x['source'])      # {'yaw': yaw, 'pitch': pitch, 'roll': roll, 't': t, 'exp': exp}
