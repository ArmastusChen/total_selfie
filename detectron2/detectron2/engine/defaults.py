...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        self.test_size = cfg.INPUT.SINGLE_HUMAN.SIZES[0]
        assert self.input_format in ["RGB", "BGR"], self.input_format

    
    
    def center_to_target_size_test(self, img, target_size):
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            # image, crop_box = self.center_to_target_size_test(original_image, self.test_size)
            ...
            # inputs = {"image": image, "height": height, "width": width, 'crop_box': crop_box}
